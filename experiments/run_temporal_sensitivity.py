...
Usage:
    uv run python experiments/run_temporal_sensitivity.py
    uv run python experiments/run_temporal_sensitivity.py --max-firms 200
    uv run python experiments/run_temporal_sensitivity.py --text-source transcript
"""
