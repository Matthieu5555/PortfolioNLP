...
Usage:
    uv run python experiments/run_scaling_experiment.py
    uv run python experiments/run_scaling_experiment.py --p-grid 100,500,1000
    uv run python experiments/run_scaling_experiment.py --text-source transcript
    uv run python experiments/run_scaling_experiment.py --p-grid 100,200 --start 2020-01-01 --end 2021-06-30
"""
