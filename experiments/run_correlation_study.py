...
Usage:
    uv run python experiments/run_correlation_study.py
    uv run python experiments/run_correlation_study.py --start 2015-01-01 --end 2022-12-31
    uv run python experiments/run_correlation_study.py --horizon 126  # semiannual
"""
