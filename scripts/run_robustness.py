...
Usage:
    uv run python scripts/run_robustness.py                          # Phase 1 only (fast)
    uv run python scripts/run_robustness.py --text-source transcript  # use transcripts
    uv run python scripts/run_robustness.py --run-shuffle             # + shuffle test
    uv run python scripts/run_robustness.py --run-tc-sensitivity      # + TC sweep
    uv run python scripts/run_robustness.py --all                     # everything
"""
