...
Usage:
    ...
    uv run python scripts/run_backtest.py --max-firms 500
    uv run python scripts/run_backtest.py --text-source transcript
    uv run python scripts/run_backtest.py --text-source combined --max-firms 500
    uv run python scripts/run_backtest.py --start 2015-01-01 --end 2023-12-31 --objective min_variance
"""
