...
Usage:
    uv run python scripts/run_cv_alpha_experiment.py
    uv run python scripts/run_cv_alpha_experiment.py --p 500
    uv run python scripts/run_cv_alpha_experiment.py --p-grid "200,500"
"""
