...
Usage:
    uv run python scripts/run_shuffle_gradient.py
    uv run python scripts/run_shuffle_gradient.py --p-grid "2000"
    uv run python scripts/run_shuffle_gradient.py --p-grid "500,1000,1500,2000" --n-shuffles 10
    uv run python scripts/run_shuffle_gradient.py --text-source transcript
"""
