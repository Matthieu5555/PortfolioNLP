...
Usage:
    uv run python scripts/run_constrained_experiment.py
    uv run python scripts/run_constrained_experiment.py --p 200
    uv run python scripts/run_constrained_experiment.py --p 500 --text-source 10k
"""
