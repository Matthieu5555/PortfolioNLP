...
Usage:
    uv run python scripts/run_pca_experiment.py
    uv run python scripts/run_pca_experiment.py --k-grid 1,3,5,10,20,50,100
    uv run python scripts/run_pca_experiment.py --k-grid 5,10,20 --max-firms 1000
    uv run python scripts/run_pca_experiment.py --text-source transcript
"""
