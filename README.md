...
The full paper is in docs/Abstract.md. The core library lives in pnlp/ (covariance estimators, portfolio optimizer, backtest engine, data loaders, baselines), experiment scripts that produce paper results are in experiments/, data download and embedding scripts are in pipeline/, tests in tests/, and the paper with supporting documentation in docs/.
